...
public class Adapter_Exp extends RecyclerView.Adapter<Adapter_Exp.ExampleViewHolder> {
    ...
    ArrayList<com.careers.app.Exp_Item> arrayList;

    public Adapter_Exp(ArrayList<com.careers.app.Exp_Item> arrayList, Adapter_Exp.OnNoteListener onNoteListener)
    {
    ...
    public void onBindViewHolder(@NonNull Adapter_Exp.ExampleViewHolder holder, int position) {
        ...
        com.careers.app.Exp_Item item=arrayList.get(position);
