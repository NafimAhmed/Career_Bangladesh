...
public class Profile_Page extends AppCompatActivity implements Adapter_Exp.OnNoteListener,Adapter3.OnNoteListener, Adapter2.OnNoteListener, AdapterView.OnItemSelectedListener{
    ...
    TextView DOB,eduinf,expinf,skillinf,JoiningDate_Text,basi,resigningDate_Text,certificate_valid_to,certificate_valid_from;
    final Calendar myCalendar= Calendar.getInstance();

    EditText eduResultType,eduResult;
    Button addedu,addskill,addexp;
...
//            sendDialogDataToActivity(editText.getText().toString());
        ...
        basi=findViewById(R.id.basic);
        eduinf=findViewById(R.id.eduinf);
        skillinf=findViewById(R.id.skillinf);
        expinf=findViewById(R.id.expinf);
...
//        recyclerView.setLayoutManager(layoutManager);
        ...
        eduinf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EduInfo();
            }
        ...
        skillinf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SkillInfo();
            }
        });
        expinf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ExpInfo();
            }
