...
public class Adapter2 extends RecyclerView.Adapter<Adapter2.ExampleViewHolder>
{
    ...
    ArrayList<com.careers.app.Item2> arrayList;

    public Adapter2(ArrayList<com.careers.app.Item2> arrayList, Adapter2.OnNoteListener onNoteListener)
    {
    ...
    public void onBindViewHolder(@NonNull Adapter2.ExampleViewHolder holder, int position) {
        ...
        com.careers.app.Item2 item=arrayList.get(position);
